...
function krown_customizer( $wp_customize ) {
	...
	$wp_customize->add_control('krown_sticky', 
		array(
			'label' => 'Sticky header',
			'section' => 'nav',
			'settings' => 'krown_sticky',
			'type' => 'select',
			'choices' => array(
				'sticky-header' => 'Enabled',
				'regular-header' => 'Disabled'
			)
		)
	);
	...
	$wp_customize->add_setting(
		'krown_p_search', array(
			'default' => 'disabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_p_search', 
		array(
			'label' => 'Show project search',
			'section' => 'nav',
			'settings' => 'krown_p_search',
			'type' => 'select',
			'choices' => array(
				'disabled' => 'Disabled',
				'enabled' => 'Enabled'
	...
	$colorsArray = array(
		...
		array(
			'label' => 'Menu Main Color',
			'default' => '#EF493F',
			'setting' => 'menu1'
		),
		array(
			'label' => 'Menu Login Links Color',
			'default' => '#55AE57',
			'setting' => 'menu2'
		),
		array(
		...
		array(
			'label' => 'Small Pie Normal Color',
			'default' => '#a9a9a9',
			'setting' => 'pie1'
		),
		array(
			'label' => 'Large Pie Normal Color',
			'default' => '#43B3CF',
			'setting' => 'pie2'
		),
		array(
			'label' => 'Pie Successful Color',
			'default' => '#6fb670',
			'setting' => 'pie3'
		)
	);
	...
	$wp_customize->add_control('rb_o_ftrtype', 
		array(
			'label' => 'Type',
			'section' => 'footer',
			'settings' => 'rb_o_ftrtype',
			'type' => 'radio',
			'choices' => array(
				'full' => 'Full',
				'minimal' => 'Minimal'
	...
	$wp_customize->add_control('rb_o_ftrareas', 
		array(
			'label' => 'Widget Areas',
			'section' => 'footer',
			'settings' => 'rb_o_ftrareas',
			'type' => 'select',
			'choices' => array(
				'one' => 'One Area',
				'two' => 'Two Areas',
