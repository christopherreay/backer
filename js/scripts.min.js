...
------------------------------------------------------- */
    ...
    if ( $body.hasClass('single-ignition_product') ) {
      ...
      if (perc < 100) perc = perc.toPrecision(2);
      var color = perc > 99 ? themeObjects.pieColor3 : themeObjects.pieColor2;
        ...
        $('.krown-pie').each(function(){
            ...
            function initPie(percent, value){
                ...
                pI = setInterval(function(){
                    ...
                    $value.html((t < 100 ? t.toPrecision(2) : t.toFixed(0)) + '<sup>%</sup>');
            ...
            if( parseFloat($value.data('percent')) != '0' ) {
            	initPie(Math.min(parseFloat($value.data('percent')).toPrecision(2),100), parseFloat($value.text()).toPrecision(2));
            }
